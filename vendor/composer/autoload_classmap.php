...
return array(
    'Ataccama\\Adapters\\Keycloak' => $vendorDir . '/ataccama/keycloak-adapter/src/Adapters/Keycloak.php',
    'Ataccama\\Adapters\\KeycloakExtended' => $vendorDir . '/ataccama/keycloak-adapter/src/Adapters/KeycloakExtended.php',
    'Ataccama\\Adapters\\Utils\\UserProfile' => $vendorDir . '/ataccama/keycloak-adapter/src/Utils/UserProfile.php',
    'Ataccama\\Auth\\Auth' => $vendorDir . '/ataccama/keycloak-adapter/src/Auth/Auth.php',
    'Ataccama\\Clients\\Keycloak\\Env\\Users\\User' => $vendorDir . '/ataccama/keycloak-adapter/src/Env/Users/User.php',
    'Ataccama\\Exceptions\\CurlException' => $vendorDir . '/ataccama/keycloak-adapter/src/Exceptions/CurlException.php',
    'Ataccama\\Exceptions\\MissingParameter' => $vendorDir . '/ataccama/keycloak-adapter/src/Exceptions/MissingParameter.php',
    'Ataccama\\Exceptions\\NotAuthenticated' => $vendorDir . '/ataccama/keycloak-adapter/src/Exceptions/NotAuthenticated.php',
    'Ataccama\\Exceptions\\NotAuthorized' => $vendorDir . '/ataccama/keycloak-adapter/src/Exceptions/NotAuthorized.php',
    'Ataccama\\Exceptions\\NotDefined' => $vendorDir . '/ataccama/keycloak-adapter/src/Exceptions/NotDefined.php',
    'Ataccama\\Exceptions\\UnknownError' => $vendorDir . '/ataccama/keycloak-adapter/src/Exceptions/UnknownError.php',
    'Ataccama\\Utils\\AccessToken' => $vendorDir . '/ataccama/keycloak-adapter/src/Utils/AccessToken.php',
    'Ataccama\\Utils\\AuthorizationResponse' => $vendorDir . '/ataccama/keycloak-adapter/src/Utils/AuthorizationResponse.php',
    'Ataccama\\Utils\\Curl' => $vendorDir . '/ataccama/keycloak-adapter/src/Utils/Curl.php',
    'Ataccama\\Utils\\KeycloakAPI' => $vendorDir . '/ataccama/keycloak-adapter/src/Utils/KeycloakAPI.php',
    'Ataccama\\Utils\\RefreshToken' => $vendorDir . '/ataccama/keycloak-adapter/src/Utils/RefreshToken.php',
    'Ataccama\\Utils\\Response' => $vendorDir . '/ataccama/keycloak-adapter/src/Utils/Response.php',
    'Ataccama\\Utils\\Token' => $vendorDir . '/ataccama/keycloak-adapter/src/Utils/Token.php',
    'Ataccama\\Utils\\UserIdentity' => $vendorDir . '/ataccama/keycloak-adapter/src/Utils/UserIdentity.php',
